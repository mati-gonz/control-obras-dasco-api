        ...
        await new Promise((resolve, reject) => {
          fileContents
            ...
            .on("finish", async (err) => {
              ...
              receiptUrl = `/dasco_receipts/${path.basename(compressedFilePath)}`;
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (req.file) {
        ...
        await new Promise((resolve, reject) => {
          fileContents
            ...
            .on("finish", async (err) => {
              ...
              // Guardar la nueva URL y eliminar el archivo original si existe
              const receiptUrl = `/receipts/${path.basename(compressedFilePath)}`;
              ...
              // Actualizar la URL y extensión del recibo
        ...
        // Si no hay nuevo archivo, actualizar solo los campos básicos
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const filePath = path.join(__dirname, "../receipts/", req.file.filename);
      const compressedFilePath = `${filePath}.gz`;
